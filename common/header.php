	...
	if($_SESSION['user']=="admin"){
		echo"
			<div class='header'>
				...
				<button class='logout'><a href='index.php?mod=validation&view=logout'>LOG OUT</a></button>
		...
		echo"
			<div class='header'>
				<h2>WELCOME <span class='color'>{$_SESSION['name']}<span></h2>
				<button class='logout'><a href='index.php?mod=student&view=logout'>LOG OUT</a></button>
			</div>
			";
	}
